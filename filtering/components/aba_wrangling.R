...
write.csv(ABA_preformat, "./outputs/filtering/origin_lists/aba_preformat.csv", row.names = F, fileEncoding = "UTF-8")
write.csv(ABA_formatted, "./outputs/filtering/wrangling_outputs/aba/aba_formatted.csv", row.names = F, fileEncoding = "UTF-8")
write.csv(aba_present, "./outputs/filtering/wrangling_outputs/aba/aba_arctic_present.csv", row.names = F, fileEncoding = "UTF-8")
write.csv(aba_absent, "./outputs/filtering/wrangling_outputs/aba/aba_arctic_absent.csv", row.names = F, fileEncoding = "UTF-8")
