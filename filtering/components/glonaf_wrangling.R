...
write.csv(glonaf_preformatted, "./outputs/filtering/origin_lists/glonaf_preformat.csv", row.names = F, fileEncoding = "UTF-8")
write.csv(glonaf_formatted, "./outputs/filtering/wrangling_outputs/glonaf/glonaf_formatted.csv", row.names = F, fileEncoding = "UTF-8")
write.csv(glonaf_species, "./outputs/filtering/wrangling_outputs/glonaf/glonaf_species_names.csv", row.names = F, fileEncoding = "UTF-8")
