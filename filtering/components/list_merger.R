merger = function() {
  ...
  components = list(
    aba = list(
      present = "./outputs/filtering/wfo_one_outputs/wfo_one_aba_arctic_present.csv",
      absent = "./outputs/filtering/wfo_one_outputs/wfo_one_aba_arctic_absent.csv"
    ),
    ambio = list(
      present = "./outputs/filtering/wfo_one_outputs/wfo_one_ambio_arctic_present.csv",
      absent = "./outputs/filtering/wfo_one_outputs/wfo_one_ambio_arctic_absent.csv"
    ),
    gbif = list(species = "./outputs/filtering/wfo_one_outputs/wfo_one_gbif_species.csv"),
    glonaf = list(species = "./outputs/filtering/wfo_one_outputs/wfo_one_glonaf_species.csv")
  )
  ...
  ## No need for parameters as R allows for lexical scoping -- meaning access to parental variables
    aba_ambio_p = function() {
      ...
      cat(yellow("writing out csv file to: \n", "./outputs/filtering/filtering_process_outputs/combined_aba_ambio_present.csv \n\n"))
      write.csv(arctic_present, "./outputs/filtering/filtering_process_outputs/combined_aba_ambio_present.csv", row.names = F, fileEncoding = "UTF-8")
    ...
    aba_ambio_a = function() {
      ...
      ## Write out list
      cat(yellow("writing out csv file to: \n", "./outputs/filtering/filtering_process_outputs/combined_aba_ambio_absent.csv \n\n"))
      write.csv(arctic_absent, "./outputs/filtering/filtering_process_outputs/combined_aba_ambio_absent.csv",  row.names = F, fileEncoding = "UTF-8")
