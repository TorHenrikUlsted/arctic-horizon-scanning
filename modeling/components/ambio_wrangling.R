...
write.csv(ambio_preformatted, "outputs/origin_lists/ambio_preformatted.csv", row.names = F, fileEncoding = "UTF-8")
write.csv(ambio_formatted, "outputs/wrangling_outputs/ambio/ambio_formatted.csv", row.names = F, fileEncoding = "UTF-8")
write.csv(ambio_present, "outputs/wrangling_outputs/ambio/ambio_arctic_present.csv", row.names = F, fileEncoding = "UTF-8")
write.csv(ambio_absent, "outputs/wrangling_outputs/ambio/ambio_arctic_absent.csv", row.names = F, fileEncoding = "UTF-8")
