crop_species = function(sp_occ_df) {
  ...
  cat(yellow("writing sp_cavm to csv: \n","outputs/gbif_retrieval_process/gbif_cavm_species.csv \n"))
  write.csv(sp_cavm, "outputs/gbif_retrieval_process/gbif_cavm_species.csv", row.names = F, fileEncoding = "UTF-8")
  ...
  cat(yellow("writing sp_boreal to csv: \n","outputs/gbif_retrieval_process/gbif_boreal_species.csv \n"))
  write.csv(sp_boreal, "outputs/gbif_retrieval_process/gbif_boreal_species.csv", row.names = F, fileEncoding = "UTF-8")
