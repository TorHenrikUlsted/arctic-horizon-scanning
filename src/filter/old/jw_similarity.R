jw_similarity_check = function(filtered_species) {
  ...
  cat(yellow("Writing csv file to: \n", "./outputs/filtering/similarity_check_outputs/jw_similarityCheck.csv \n"))
  write.csv(simCheck_filt_sp, "./outputs/filtering/similarity_check_outputs/jw_similarityCheck.csv", row.names = F, fileEncoding = "UTF-8")
